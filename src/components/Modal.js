              ...
              <div className="container">
                <div className="row justify-content-center">
                  <div className="col-lg-8">
                    <h2
                      className="portfolio-modal-title mb-0"
                    ...
                    <div className="divider-custom">
                      ...
                      <div className="divider-custom-icon">
                        <img
                          src={theme.id % 2 !== 0 ? data.icon : data.icon_white}
                          alt="Project Icon"
                          height={50}
                        />{" "}
                      </div>
            ...
            <div className="modal-footer justify-content-center mb-5">
              <a href={data.url} target="_blank" rel="noreferrer">
                <button
                  ...
                  style={{
                    ...theme.primary,
                    border: theme.primary.backgroundColor,
                  }}
                >
                  <i className="fas fa-external-link-alt mr-2"></i>Go to site
                </button>
              </a>
              <button
