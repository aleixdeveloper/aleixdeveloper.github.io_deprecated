                                ...
                                <div className="row justify-content-center">
                                    <div className="col-lg-8">
                                        ...
                                        <div className="divider-custom">
                                            ...
                                            <div className="divider-custom-icon"><img src={theme.id % 2 !== 0 ? data.icon : data.icon_white} alt='Project Icon' height={50} /> </div>

                                            <div className="divider-custom-line" style={theme.primary}></div>
                                        </div>
                                        <img className="img-fluid rounded mb-5" id="img-modal" src={data.img} alt={data.alt} />
                                        <div>{data.techIcons.map(icon => <img height={'35em'} /* key={data.indexOf(icon)} */ alt='Tech icon' className="m-2" src={icon}></img>)}</div>
