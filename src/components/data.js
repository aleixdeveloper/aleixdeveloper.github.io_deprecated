...
export const data = [
    ...
    },
    {
        ...
        text: 'An online shop to sell any kind of products you want. Manage orders, products and users from the admin control. Review system integrated',
        icon: ecommerce_icon,
        icon_white: ecommerce_icon_white,
        url: 'https://venda-online.herokuapp.com',
        techIcons: [react_icon, node_icon, mongodb_icon, express_icon, redux_icon, bootstrap_icon, heroku_icon]
    },
    {
        id: 3,
        name: 'Lichess',
    ...
    },
    {
        ...
        img: fenok,
        alt: 'fenok',
        text: 'Rock band website made with Wordpress, with some changes in the CSS and PHP code.',
        icon: fenok_icon,
