  ...
  return (
    <header className="masthead text-center" style={theme.primary}>
      <div className="container header d-flex align-items-center flex-column">
        <div
          className="img-hover-zoom img-hover-zoom--xyz"
          onMouseOver={hoverIn}
          onMouseOut={hoverOut}
          style={{ boxShadow: `0px 0px 10px ${theme.secondary.background}` }}
          ref={photo}
        >
          <img
        ...
        <h1 className="masthead-heading mb-0" style={h1Style}>
          Aleix Clemente
        </h1>
        ...
        <div className="divider-custom divider-custom-code">
          <div
            ...
            style={theme.primaryReversed}
          ></div>
          <div className="divider-custom-icon">
            <img
              src={theme.id % 2 !== 0 ? code_white : code_black}
              alt="Code icon </>"
              style={code_iconStyle}
            />
          </div>
          <div
            className="divider-custom-line"
