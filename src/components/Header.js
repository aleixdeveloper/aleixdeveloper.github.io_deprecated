...
const Header = () => {
    ...
    const hoverIn = () => {
        ...
        photo.current.style.boxShadow = `0px 0px 30px ${theme.secondary.background}`;
    }
...
<header className="masthead text-center" style={theme.primary}>
            <div className="container d-flex align-items-center flex-column">
                ...
                <div className="divider-custom">
                    ...
                    <div className="divider-custom-icon"><img src={theme.id %2 !== 0 ? code_white : code_black} style={code_iconStyle} /></div>
                    <div className="divider-custom-line" style={theme.primaryReversed}></div>
                </div>
